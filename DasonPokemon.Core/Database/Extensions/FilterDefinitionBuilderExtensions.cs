...
namespace MongoDB.Extensions.Repository.Extensions
{
    public static class FilterDefinitionBuilderExtensions
    {
        ...
        public static FilterDefinition<TEntity> IdEq<TEntity>(this FilterDefinitionBuilder<TEntity> filter, Guid id)
            where TEntity : MongoEntity
            => filter.Eq(x => x.Id, id);

        public static FilterDefinition<TEntity> NotDeletedAndIdEq<TEntity>(this FilterDefinitionBuilder<TEntity> filter, Guid id)
            where TEntity : SoftDeletableMongoEntity
