...
namespace MongoDB.Extensions.Repository
{
        ...
        where TEntity : SoftDeletableMongoEntity
    {
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns></returns>
        public virtual async Task<bool> UnDeleteAsync(Guid id, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns></returns>
        public override async Task<TEntity?> GetAsync(Guid id, CancellationToken cancellationToken = default) =>
